...
- Development (hot reload):
    ...
    - The sqlite database is stored in a volume mounted at /app/data (volume name: db_data). Source code is bind-mounted
      for live reload.
...
- DATABASE_URL is configured to use sqlite at /app/data/*.db. Prisma migrations are applied automatically on startup (
